    ...
    <section className="py-20 md:py-28">
      <div className="container-church">
        <SectionTitle
          ...
          description="Ne manquez aucun de nos événements. Rejoignez-nous pour des moments de communion et de célébration."
        />
        ...
        <div className="mt-12 grid gap-6 md:grid-cols-3">
          {upcoming.map((event) => (
            <ScrollReveal
              key={event.id}
              animation="fadeUp"
              className="group overflow-hidden rounded-2xl border border-[var(--color-gray-200)] bg-white transition-all duration-500 hover:-translate-y-1 hover:shadow-xl"
            >
              {/* Date header */}
